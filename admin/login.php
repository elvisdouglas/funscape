                ...
                <div class="row align-items-center">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group mb-3">
                            <button class="btn btn-lg btn btn-outline-info w-100 fs-6" style="font-weight: bold">Login</button>
                        </div>
                        <div class="form-group mb-3">
                            <button class="btn btn-lg btn btn-outline-danger w-100 fs-6"><a href="signup.php" style="font-weight:bolder; text-decoration: none; color: #fff">Sign Up</a></button>
                        </div>
                    </form>
